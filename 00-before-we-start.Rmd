...
```{r, results='markup',fig.cap="How it should look like at the beginning of this lesson", echo=FALSE, out.width='100%', fig.align='center'}
...
```{r kitten-img, results='markup', echo=FALSE, out.width='400px', fig.align='center'}
...
To quickly remind yourself of argument names and default values, rely on RStudio
and configure its auto-completion under Tools -> Global Options ->
Code -> Completion.
